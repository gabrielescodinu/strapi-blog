    ...
    return (
        <header>
            ...
            <div className={`-m-4 search-panel origin-bottom transform transition-transform duration-300 w-screen h-screen fixed bg-gray-400/[.95] z-40 flex flex-col justify-center lg:px-60 ${isSearchOpen ? 'translate-y-0' : 'translate-y-full'}`} >
                ...
                <form class="max-w-screen-xl px-4 sm:px-6 z-50 mx-auto w-full">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" value={search} onChange={handleSearchChange} id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-700 border-none shadow-2xl bg-gray-200/[.85] focus:ring-transparent focus:border-transparent" placeholder="" required />
                ...
                <nav className="z-30 relative max-w-screen-xl  mx-auto text-gray-500 md:px-8">
                    <div className="flex justify-between items-center absolute w-full left-0 lg:px-8">
                        ...
                        <ul className="items-center hidden space-x-8 lg:flex text-base">
                            ...
                            <li><div aria-label="Our product" title="Our product" className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-[#FA2200]"><Link to="/archive">Archive</Link></div></li>
